...
# We use osascript to open a new terminal window for the frontend
osascript -e 'tell app "Terminal" to do script "cd '$PWD'/frontend && REACT_APP_API_URL=http://localhost:5001 npm start"'
