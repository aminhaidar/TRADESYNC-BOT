...
# Note: We're NOT specifying a custom redirect_url here,
# so Flask-Dance will use the default '/auth/google/authorized'
...
# Using Flask-Dance's default callback URL pattern
@app.route('/auth/google/authorized')
def google_authorized():
    if not google.authorized:
        logger.warning("OAuth callback reached but not authorized")
